...
export default function BusinessProfile({ navigateTo }) {
  ...
  const handleSave = async (e) => {
    ...
    const result = await updateUser({ ...form, logo: logoBase64, stamp: stampBase64, show_stamp: showStamp });
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-16">
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="glass-panel rounded-2xl border border-slate-700/50 p-6 space-y-4">
          ...
          <div className="pt-2 border-t border-slate-700/50 mt-4 flex items-center gap-3">
            <input 
              type="checkbox" 
              id="show-stamp-global"
              checked={showStamp}
            ...
            />
            <label htmlFor="show-stamp-global" className="text-sm text-slate-300 cursor-pointer">
              Show stamp on generated invoices by default
            </label>
          </div>
        </div>
