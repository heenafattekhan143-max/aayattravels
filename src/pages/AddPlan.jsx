...
export default function AddPlan({ navigateTo }) {
  ...
  const validate = () => {
    ...
    if (!formData.company_rate) {
      tempErrors.company_rate = formData.plan_type === 'Local' ? "Company base rate is required." : "Company per day rate is required.";
    ...
    if (!formData.vendor_rate) {
      tempErrors.vendor_rate = formData.plan_type === 'Local' ? "Vendor base rate is required." : "Vendor per day rate is required.";
            ...
            {formData.plan_type === 'Local' ? (
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-slate-400">Company Base Rate (Rs.) <span className="text-rose-500">*</span></label>
                      <input
                        type="text"
                        name="company_rate"
                    ...
                    <div className="space-y-1">
                      <label className="text-xs font-semibold text-slate-400">Vendor Base Rate (Rs.) <span className="text-rose-500">*</span></label>
                      <input
                        type="text"
                        name="vendor_rate"
              ...
              <>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                  ...
                  {/* Rates */}
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-slate-400">Company Per Day Rate (Rs.) <span className="text-rose-500">*</span></label>
                    <input
                      type="text"
                      name="company_rate"
                      placeholder="e.g. 4000"
                  ...
                  <div className="space-y-1">
                    <label className="text-xs font-semibold text-slate-400">Vendor Per Day Rate (Rs.) <span className="text-rose-500">*</span></label>
                    <input
                      type="text"
                      name="vendor_rate"
                      placeholder="e.g. 3500"
