        ...
        <div className="glass-panel rounded-xl border border-slate-800 p-5 md:p-6 space-y-6">
          ...
          {formData.plan_type === 'Local' ? (
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400">Base Hours</label>
                  <input
                    type="number"
                    name="base_hours"
                    placeholder="e.g. 8"
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400">Base KMs</label>
                  <input
                    type="number"
                    name="base_km"
                    placeholder="e.g. 80"
          ...
          <div className="border-t border-slate-800/50 pt-4 mt-4">
            ...
            {formData.plan_type === 'Local' && (
              <div className="grid grid-cols-2 gap-4 mt-3">
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-400">HOUR RATE (₹) <span className="text-rose-500">*</span></label>
                  <input
                    type="text"
